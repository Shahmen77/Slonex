...
export async function getPageContent({ slug }: { slug: string }) {
...
export async function getTranslations({ language }: { language: string }) {
...
export async function _seedInitialData() {
  ...
  await db.contactInfo.create({
    data: {
      ...
      inn: "ИНН 9909677607",
      telegramBot: "https://t.me/check_legal_net_dev_bot",
    },
  });
  ...
  const translations = [
    ...
    { key: "info.title", language: "ru", value: "Информация" },
    {
      ...
      language: "ru",
      value:
        " система для сбора информации о юридических лицах из всех открытых источников.",
    },
